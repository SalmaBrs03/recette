...
import 'package:recipe_app/screens%20/detail_screen.dart';

import '../components/custom_app_bar.dart';
//import 'package:recipe_app_tutorial/constants/constant_function.dart';
      ...
      body: FutureBuilder(
          ...
          builder: (context,snapshot){
            if(snapshot.connectionState==ConnectionState.waiting){
              ...
              return const Center(child: Text('nod data'),);
            }
                            ...
                            child: Stack(
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: Center(
                                    child: Text("${time.toString()} min",style: TextStyle(
                                      color: Colors.white
                                    ),),
                                  ),
                                ))
